...
public class configuration implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("23/10/2002"), "Partiu viagem", "Vou viajar para Pernambuco", maria);
		Post post2 = new Post(null, sdf.parse("21/09/2002"), "Bom dia", "Acordei Feliz Hoje!", maria);
